...
public class TransportBookingService {
    ...
    private TransportBookingResponse convert(
    	...
    	return new TransportBookingResponse(
    		    ...
    		    booking.getTransportation().getTransportNumber(),
    		    booking.getTransportation().getSource(),
    		    booking.getTransportation().getDestination(),
    		    booking.getTransportation().getDepartureTime(),
    		    booking.getSeatsBooked(),
